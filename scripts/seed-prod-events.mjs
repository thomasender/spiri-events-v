...
const TEST_EVENTS = [
  ...
  { title: 'Atemtherapie Workshop', category: 'Breathwork', description: 'Bewusste Atemarbeit für mehr Energie.', place: 'Gesundheitszentrum Bregenz', bezirk: 'Bregenz', dayOffset: 6, contribution: 'fee', fee: 45 },
  { title: 'Soundhealing Klangreise', category: 'Soundhealing', description: 'Sanfte Klangreise mit Kristall-Singingbowls.', place: 'Klangraum Bregenz', bezirk: 'Bregenz', dayOffset: 12, contribution: 'fee', fee: 30 },
  ...
  { title: 'Grenznahe Veranstaltung', category: 'Breathwork', place: 'Lindau Hafen', bezirk: 'Grenznahe', dayOffset: 39, contribution: 'fee', fee: 25 },
