...
const ADMIN_OWNED_APPROVED_SLUG = generateSlug('Yoga heute', 'Yoga', 'Dornbirn', 0);
const USER_OWNED_APPROVED_SLUG = generateSlug('User Approved Event', 'Yoga', 'Bregenz', 9);
const USER_OWNED_PENDING_SLUG = generateSlug('User Pending Event', 'Sonstiges', 'Bludenz', 8);
