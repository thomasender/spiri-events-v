    ...
    <div className="wizard-step-content">
      ...
      <div className="form-group">
        ...
        <p className="image-hint" data-testid="title-image-hint">
          Tipp: Verwende als Titelfoto am besten ein schönes Symbolfoto mit wenig Text. Fotos mit
          viel Text (z.B. ein Flyer) kannst du im Feld „Beschreibung“ zusätzlich zu deinem
              ...
              : formData.contribution === 'donation'
                ...
                : formData.fee
                  ? `Gebühr: ${formatPriceWithCurrency(formData.fee, formData.priceCurrency) || formData.fee}${
                      formData.feeNote ? ` / ${formData.feeNote}` : ''
                    }`
                  : formData.feeNote
                    ? `Gebühr: ${formData.feeNote}`
                    : 'Kostenpflichtig'}
          </p>
        </div>
      </div>
